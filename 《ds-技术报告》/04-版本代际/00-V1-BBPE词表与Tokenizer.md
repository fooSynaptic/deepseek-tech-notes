...
Tokenizer 训练语料来自 V1 **三阶段数据 pipeline** 的多语言子集（与 [V1 §2.1 数据](00-V1-LLM.md#21-数据) / [#tokenizer](00-V1-LLM.md#tokenizer) 同一论文段落）：
...
| **V3.2 / R1** | 与 V3 **同词表** |
| **V4** | 随新旗舰再扩展（[DeepSeek-V4 梗概 · 训练章节](03-V4.md#训练要点)） |
